...
<MetaTags
  ...
  openGraph={{
    ...
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-bootstrap-svg-icons',
        width: 1200,
        height: 630,
...
<Footer footerType="logo" class="dark:bg-slate-950">
  <div class="sm:flex sm:items-center sm:justify-between">
    ...
    >
      ...
      <FooterLink href="https://github.com/shinokada/svelte-bootstrap-svg-icons/blob/main/LICENSE"
