...
>
  <NavBrand href="/">
    <span
      class="text-primary-900 dark:text-primary-500 self-center text-xl font-semibold whitespace-nowrap xl:ml-8 xl:text-3xl"
  ...
  <div class="flex justify-end xl:order-2">
    ...
    {/if}
    <DotsHorizontalOutline class="mt-1.5 mr-4 ml-6 dark:text-white" size="xl" />
