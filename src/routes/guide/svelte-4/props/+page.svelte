<script lang="ts">
  import { Code, H1, H2, H3 } from 'runes-webkit';
...
<HighlightCompo lang="ts" code={modules['./md/events.md'] as string} />

<HighlightCompo lang="ts" code={modules['./md/events-2.md'] as string} />
