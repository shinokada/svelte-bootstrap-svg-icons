<script>
  ...
  export let ariaLabel = 'opencollective';
</script>
...
>
  ...
  />
  <path
    d="M8 13.151a4.995 4.995 0 1 1 0-9.99c1.015 0 1.951.273 2.732.82l1.95-2.03a7.805 7.805 0 1 0 .04 12.449l-1.951-2.03a5.072 5.072 0 0 1-2.732.781H8Z"
  />
</svg>
...
@prop export let ariaLabel = 'opencollective';
-->
